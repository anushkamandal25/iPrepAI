...
const Landingpage = () => {
  ...
  return (
        ...
        <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
          ...
          <div className="w-full md:w-1/2 ">
            <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
              Get role-specific interview questions, expand answers when you need more context, and organize everything your way. From preparation to mastery- your ultimate tool for interview success.
            </p>

            <button className="bg-black text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-yellow-100 hover:text-black border border-yellow-50 border-yellow-300 transition-colors cursor-pointer" onClick={handleCTA}> Get Started</button>
          </div>
        </div>
        </div>
        </div>
    ...
    <div className=" text-sm bg-gray-50 text-secondary text-center p-5 mt-5">
      Made with ❤️ by Anushka Mandal. Copyright © 2025. All rights reserved.
    </div>
